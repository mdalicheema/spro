                    ...
                    <div class="card-body">
                        <form action="{{ url('/about/update/'.$about->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="short_info" class="form-control" id="exampleInputEmail1" value="{{ $about->short_info }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="7" cols="50" name="long_info" class="form-control"
                                    id="exampleInputEmail1" placeholder="Enter details...">{{ $about->long_info }}</textarea>
                                @error('long_info')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
