...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                                ...
                                <div class="col-md-12">
                                    @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                                        <div class="d-inline-block mr-3">
                                            ...
                                            <a target="_blank" href=".route('policy.show').">privacy</a> --}}
                                    ...
                                    <p>Already have an account?
                                        <a class="text-blue" href="{{ asset('login') }}">Sign in</a>
                                    </p>
                                </div>
                            </div>
                        </form>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright Sahulatkar Dashboard Bootstrap Template by
                <a class="text-primary" href="http://www.alicheema.com/" target="_blank">AliCheema</a>.
            </p>
        </div>
    </div>
</body>
